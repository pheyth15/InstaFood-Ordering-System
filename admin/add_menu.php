...
<head>
    ...
    <title>Add Menu - Admin | InstaFood</title>
    <!-- Bootstrap Core CSS -->
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Menu to a Store</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="d_name" class="form-control" placeholder="Food Name">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
